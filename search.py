...
def get_top_k_similar(image_data, pred, pred_final, tagResult, k):
...
def delImageWishlist(name, tags):
    lines = []
...
def getImgStatus(names):
    ...
    for name in names:
        try:
            ...
            name["inWishlist"] = True
        except:
            name["inWishlist"] = False
